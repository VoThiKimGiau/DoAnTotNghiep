...
import 'package:datn_cntt304_bandogiadung/dto/ChiTietDonHangDTO.dart';
...
class ChiTietDonHangController {
  ...
  Future<List<ChiTietDonHangDTO>> fetchListProduct(String madh) async {
    final response = await http.get(
    ...
    if (response.statusCode == 200) {
      ...
      return jsonResponse.map((item) => ChiTietDonHangDTO.fromJson(item)).toList();
    } else {
